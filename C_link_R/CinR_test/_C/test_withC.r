...
dyn.load("C:/Users/darek/Desktop/C_link_R/CinR_test/_C/hello.dll")
...
.C("hey", as.integer(2))
dyn.unload("C:/Users/darek/Desktop/C_link_R/CinR_test/_C/hello.dll")

#####################################

#fak.dll wird geladen
dyn.load("C:/Users/darek/Desktop/C_link_R/CinR_test/_C/fak.dll")

#Funktion fak berechnet n!
.C("fak", fakultat= as.integer(5))
dyn.unload("C:/Users/darek/Desktop/C_link_R/CinR_test/_C/fak.dll")
